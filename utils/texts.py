...
ADD_PARTNER_GROUP = (
    ...
    "peer_id можно получить командой /id в нужной беседе.\n\n"
    "Мини-инструкция по токену:\n"
    "1. Откройте настройки сообщества VK.\n"
    "2. Перейдите в Работа с API -> Ключи доступа.\n"
    "3. Создайте ключ с правами wall, photos и messages.\n"
    "4. Скопируйте ключ и отправьте его вместе со ссылкой на сообщество."
)
...
BUY_GROUP_AD_TEXT = (
    "Добавьте бота в VK-беседу, которую нужно добавить в подписочные условия.\n"
    "После добавления я продолжу настройку здесь, в личке.\n\n"
    "Если бот уже добавлен, отправьте сюда peer_id беседы вида 2000001234. "
    "Команда /id в беседе пришлет peer_id в личку и удалится из чата."
)
